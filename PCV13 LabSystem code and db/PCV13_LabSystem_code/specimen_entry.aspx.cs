...
namespace PCV13_LabSystem
{
    public partial class specimen_entry : System.Web.UI.Page
    {
        ...
        "q23, " +
        " comments " +
        " FROM sample_entry a inner join sample_recv b on a.studyid = b.studyid and b.studyid = '" + sno + "'";
       ...
       " FROM sample_recv where studyid='" + studyid.Text + "'";
                    ...
                    string child_id = GetDataFieldWise("0", qry, "childid", studyid.Text);
                    obj_op = null;
        ...
        public static string GetDataFieldWise(string id, string spName, string fieldname, string fieldvalue)
        {
            string value = "";
            ...
            try
            {
                ...
                DataSet ds = ExecuteNonQuery_Qry(fldname, fldvalue, spName);
                ...
                if (childid1 != "999999999")
                {
                    ...
                    if (ds != null)
                    {
                        if (ds.Tables.Count > 0)
                        {
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                if (childid1 == ds.Tables[0].Rows[0]["q4"].ToString() && studyid.Text != ds.Tables[0].Rows[0]["studyid"].ToString())
                                {
                                    IsExists = true;
        ...
        private void SaveData(string id)
        {
            ...
            try
            {
                ...
                string[] arr_entry_dt = dt_entry.ToShortDateString().Split('/');
                entry_dt = arr_entry_dt[1] + "/" + arr_entry_dt[0] + "/" + arr_entry_dt[2];



                string qry = "INSERT INTO sample_entry (" +
"studyid," +
"q1," +
"q2," +
"q3," +
...
entry_dt + "')";
                ...
                errmsg = ExecuteNonQuery_Qry_Insert_Update(fldname, fldvalue, qry);
        ...
        private void UpdateData(string id)
        {
            ...
            try
            {
                ...
                string qry = "UPDATE sample_entry set " +
...
"q15b7 = '" + q15b7.Text + "', " +
"q15c7 = '" + var_Q15_c7 + "', " +
"q16signa1 = '" + q16signa1.Text + "', " +
"q16a1 = '" + q16a1.Text + "', " +
"q16b1 = '" + q16b1.Text + "', " +
"q16c1 = '" + var_Q16_c1 + "', " +
"q16signa2 = '" + q16signa2.Text + "', " +
"q16a2 = '" + q16a2.Text + "', " +
"q16b2 = '" + q16b2.Text + "', " +
"q16c2 = '" + var_Q16_c2 + "', " +
"q16signa3 = '" + q16signa3.Text + "', " +
"q16a3 = '" + q16a3.Text + "', " +
"q16b3 = '" + q16b3.Text + "', " +
"q16c3 = '" + var_Q16_c3 + "', " +
"q16c = '" + q16c.Text + "', " +
...
"q22 = '" + q22.Text + "', " +
"q23 = '" + q23_1_val + "', " +
"comments = '" + Comments.Text + "' where studyid='" + studyid.Text + "'";
