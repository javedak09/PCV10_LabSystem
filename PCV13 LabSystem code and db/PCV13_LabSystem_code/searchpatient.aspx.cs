...
namespace PCV13_LabSystem
{
    public partial class searchpatient : System.Web.UI.Page
    {
        ...
        "b.q3a, " +
        "q4a, " +
        "convert(varchar(13), b.q5dt, 103) q5dt, " +
        "case when q5 = 1 then 'Yes' " +
        "     when q5 = 2 then 'No' " +
        "end q5, " +
        "case when b.q7 = 1 then 'Yes' " +
        ...
        "q9, " +
        "convert(varchar(13), q10dt, 103) q10dt, " +
        "convert(varchar(5), q10t, 114) q10t, " +
        "q10t, " +
        "q11, " +
        "case when q12 = 1 then 'Yes' " +
        "     when q12 = 2 then 'No' " +
        ...
        " FROM sample_recv where studyid='" + studyid.Text + "'";
                ...
                string val = obj_op.GetDataFieldWise("0", qry, "q6", studyid.Text);
        ...
        " FROM sample_entry a inner join sample_recv b on a.studyid = b.studyid and b.studyid = '" + studyid.Text + "'";
                ...
                string val1 = obj_op.GetDataFieldWise("1", qry, "q2", studyid.Text);
                obj_op = null;
        ...
        " FROM sample_recv where studyid='" + studyid.Text + "'";
            ...
            string val = GetDataFieldWise("0", qry, "q6", studyid.Text);
        ...
        " FROM sample_entry a inner join sample_recv b on a.studyid = b.studyid and b.studyid = '" + studyid.Text + "'";
            ...
            string val1 = GetDataFieldWise("1", "sp_GetRecords", "q2", qry);
        ...
        protected void DG_Request_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            string id = "";

            DG_Request.Columns[0].Visible = true;
            id = DG_Request.Rows[e.RowIndex].Cells[0].Text;
            DG_Request.Columns[0].Visible = false;
