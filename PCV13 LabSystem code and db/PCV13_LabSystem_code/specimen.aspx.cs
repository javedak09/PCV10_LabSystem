...
namespace PCV13_LabSystem
{
    public partial class specimen : System.Web.UI.Page
    {
        ...
        "convert(varchar(5), q9t, 114) q9t, " +
        "q9t, " +
        "q10, " +
        "q10a, " +
        "q8a, " +
        "convert(varchar(13), q9dt1, 103) q9dt1, " +
        "convert(varchar(5), q9ta, 114) q9ta, " +
        "q9ta, " +
        "q10a1, " +
        "q10a2 " +
        " FROM sample_recv where studyid='" + sno + "'";
                ...
                if (ds != null)
                {
                    if (ds.Tables.Count > 0)
                    {
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            CVariables.IsRecordUpdate = true;
                            ...
                            q5dt.Text = ds.Tables[0].Rows[0]["q5dt"].ToString();
                            ...
                            q9dt.Text = ds.Tables[0].Rows[0]["q9dt"].ToString();
                            ...
                            q9dt1.Text = ds.Tables[0].Rows[0]["q9dt1"].ToString();
        ...
        public static string ExecuteNonQuery_Qry_Insert_Update(string[] fieldName, string[] fieldValues, string qry)
        {
            SqlCommand cmd = null;
            CConnection cn = null;
            ...
            try
            {
                ...
                for (int a = 0; a <= fieldName.Length - 1; a++)
                {
                    ...
                    {
                        if (fieldName[a] == "DOP" || fieldName[a] == "StartDate" || fieldName[a] == "EndDate"
                            || fieldName[a] == "AADOP"
                            || fieldName[a] == "q5dt"
                            || fieldName[a] == "q9dt"
                            || fieldName[a] == "q9dt1"
                ...
                if (childid1 != "999999999")
                {
                    ...
                    if (ds != null)
                    {
                        if (ds.Tables.Count > 0)
                        {
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                if (childid1 == ds.Tables[0].Rows[0]["childid"].ToString() && studyid.Text != ds.Tables[0].Rows[0]["studyid"].ToString())
                                {
                                    IsExists = true;
                                    lblerr.Text = "Child ID [ " + childid1 + " ] already exists against study id  [ " + ds.Tables[0].Rows[0]["studyid"].ToString() + " ]";
                                    lblerr.CssClass = "message-error";
                                }
                            }
                        }
        ...
        protected void cmdSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (cmdSave.Text == "  Save " && CVariables.IsRecordUpdate == true)
                {
                    string id = Session["id"].ToString();
        ...
        private void SaveData(string id)
        {
            ...
            try
            {
                ...
                string[] arr_dt_entry = dt_entry.ToShortDateString().Split('/');
                string entry_dt = arr_dt_entry[1] + "/" + arr_dt_entry[0] + "/" + arr_dt_entry[2];
                ...
                if (string.IsNullOrEmpty(q5dt.Text) == false)
                {
                    ...
                    string[] arr_dt_q5 = dt_q5.ToShortDateString().Split('/');
                    dt_q5_dt = arr_dt_q5[1] + "/" + arr_dt_q5[0] + "/" + arr_dt_q5[2];
                }
                ...
                if (string.IsNullOrEmpty(q9dt.Text) == false)
                {
                    ...
                    string[] arr_dt_q9 = dt_q9.ToShortDateString().Split('/');
                    dt_q9_dt = arr_dt_q9[1] + "/" + arr_dt_q9[0] + "/" + arr_dt_q9[2];
                }
                ...
                if (string.IsNullOrEmpty(q9dt1.Text) == false)
                {
                    ...
                    string[] arr_dt_q9a = dt_q9a.ToShortDateString().Split('/');
                    dt_q9a_dt = arr_dt_q9a[1] + "/" + arr_dt_q9a[0] + "/" + arr_dt_q9a[2];
                }
                ...
                string qry = "INSERT INTO sample_recv (" +
"studyid," +
"childid," +
"dssid," +
"q1," +
...
entry_dt + "')";
                ...
                string errmsg = ExecuteNonQuery_Qry_Insert_Update(fldname, fldvalue, qry);
        ...
        private void UpdateData(string id)
        {
            ...
            try
            {
                ...
                string qry = "UPDATE sample_recv set " +
...
"q9ta = '" + mytime_q9ta + "', " +
"q10a1 = '" + q10a1.Text + "', " +
"q10a2 = '" + q10a2.Text + "' where studyid = '" + studyid.Text + "'";
