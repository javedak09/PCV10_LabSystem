<%@ Page Title="" Language="C#" MasterPageFile="~/Site_S.Master" AutoEventWireup="true" CodeBehind="searchpatient.aspx.cs" Inherits="PCV10_LabSystem.searchpatient" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        ...
        <tr>
            <td>
                <asp:GridView ID="DG_Request" Name="DG_Request" runat="server" AllowPaging="True" AutoGenerateColumns="False" Width="1167px" BorderColor="#00CC66" BorderStyle="Solid" BorderWidth="2px" PageSize="20" OnRowCommand="DG_Request_RowCommand" OnRowEditing="DG_Request_RowEditing" OnPageIndexChanging="DG_Request_PageIndexChanging">
                    ...
                    <ItemTemplate>
                        <table border="0" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label22142" runat="server" CssClass="text-caps_datalist" Text='<%# Bind("q5dta") %>'></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lblRESPPERSONNAMEValue" runat="server" CssClass="text-caps_datalist" Text='<%# Bind("q9dta") %>'></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label98" runat="server" CssClass="text-caps_datalist" Text='<%# Bind("q9dt1a") %>'></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                ...
                                <td>
                                    <asp:Label ID="Label100" runat="server" CssClass="text-caps_datalist" Text='<%# Bind("q9ta") %>'></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                ...
                                <td>
                                    <asp:Panel ID="pnl_receiving" runat="server">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lbl_q6dta" runat="server" CssClass="text-caps_datalist" Text='<%# Bind("q5dta") %>'></asp:Label>
                                            </td>
                                            <td>&nbsp;
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lbl_q10dta" runat="server" CssClass="text-caps_datalist" Text='<%# Bind("q10dta") %>'></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
